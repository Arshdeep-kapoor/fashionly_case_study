...
view: order_items {
  ...
  measure: all_customers {
    type: count_distinct
    sql: ${user_id} ;;
  }

  measure: percent_of_customers_returning {
    type: number
    value_format_name: percent_2
    sql: ${number_of_customer_returning_items} / ${all_customers} ;;
  }

  measure: avg_spend_per_customer {
    type: number
    value_format_name: usd
    sql: ${total_sale_price} / NULLIF(${all_customers},0) ;;
  }
